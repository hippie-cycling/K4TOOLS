...
class CryptoToolGUI(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.output_text = self.create_text_widget(self.output_frame, "", width=1000, height=1000)
    ...
    def boolean_operations(self):
        ...
        input1 = self.input1_text.toPlainText()
        input2 = self.input2_text.toPlainText()
